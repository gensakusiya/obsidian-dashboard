...
/**
 * Get all fleeting notes from FleetingNotes folder
 */
export async function getAllFleetingNotes(
	app: App
	...
	const notesBySource: Record<string, FleetingNote[]> = {};
	...
	for (const file of files) {
		try {
			...
			notesBySource[file.name.replace(".md", "")] = tasks;
		} catch (error) {
			console.error(
